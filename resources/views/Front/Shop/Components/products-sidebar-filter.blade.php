...
<form action="{{ request()->segment(2) == 'products' ? 'shop' : '' }}">
    ...
    <div class="filter-widget">
        ...
        <div class="filter-range-wrap">
            <div class="range-slider">
                ...
                <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ul-widget ul-widget-content " data-min="10" data-max="999" data-min-value="{{ str_replace('$', '', request('price_min')) }}" data-max-value="{{ str_replace('$', '', request('price_max')) }}">
                    <div class="ui-slider-range ui-corner-all ul-widget-header"></div>
    ...
    <div class="filter-widget">
        ...
        <div class="fw-color-choose">
            ...
            <div class="cs-item">
                <input type="radio" id="cs-yellow" name="color" value="yellow" onchange="this.form.submit();" {{ request('yellow') == 'black' ? 'checked' : '' }}>
