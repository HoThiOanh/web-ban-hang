...
<head>
    ...
    <title>@yield('title') | WebBanHang</title>
                ...
                <div class="ht-right">
                    ...
                    <div class="lan-selector">
                        <select class="language_drop" name="countries" id="countries" style="width:300px";>
                            ...
                            <option value="yt" data-image="front/img/flag-2.jpg" data-imagecss="flag yu" data-title="Bangladesh">VietNam</option>
                        </select>
                    </div>
                                            ...
                                            <tbody>
                                                @foreach(Cart::content() as $cart)
                                                    <tr data-rowId="{{ $cart->rowId }}">
                                                        <td class="si-pic">
                                                            <img style="height: 70px;" src="front/img/products/{{ $cart->options->images[0]->path }}">
                                                        </td>
                                                        <td class="si-text">
                ...
                <div class="nav-depart">
                    <div class="depart-btn">
                        ...
                        <ul class="depart-hover">
                            <li class="active"><a href="#">Monen's Clothing</a></li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="footer-left">
                        ...
                        <ul>
                            <li>1 Truong Chinh, Ha Noi</li>
                            <li>Phone: 0358626210</li>
                            <li>Email: hoathioanh07082000@gmail.com</li>
                        </ul>
                ...
                <div class="col-lg-4">
                    <div class="newslatter-item">
                        ...
                        <p>Get E-mail updates about our latest shop and spwcial offers</p>
