                            ...
                            <div class="widget-content-left">
                                <div class="btn-group">
                                    <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                       class="p-0 btn">
                                        <img width="42" class="rounded-circle" src="front/img/product-single/{{Auth::user()->avatar ?? 'avatar-1.jpg'}}"
                                             alt="">
                                                        ...
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <img width="42" class="rounded-circle"
                                                                     src="front/img/product-single/{{Auth::user()->avatar ?? 'avatar-1.jpg'}}" alt="">
                                                            </div>
                                                            <div class="widget-content-left">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="widget-content p-0">
                                <div class="widget-content-wrapper">
                                    ...
                                    <div class="widget-content-left mr-3">
                                        <div class="widget-content-left">
                                            <img width="42" class="rounded" src="front/img/product-single/{{ Auth::user()->avatar ?? 'avatar-1.jpg' }}"
                                                 alt="" />
                                        </div>
                                    </div>
                                    <div class="widget-content-left">
